...
class TestAuditLogging:
    ...
    def test_audit_log_creation(self, auth_client):
        ...
        resp = client.post("/api/v1/simulate", json={
            "product": "AuditTest", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Positive", "supply_status": "High",
            "season": "Normal",
        }, headers=headers)
    ...
    def test_audit_event_fields(self, auth_client):
        ...
        client.post("/api/v1/simulate", json={
            "product": "FieldTest", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Neutral", "supply_status": "Medium",
            "season": "Normal",
        }, headers=headers)
    ...
    def test_audit_filter_by_action(self, auth_client):
        ...
        client.post("/api/v1/simulate", json={
            "product": "FilterTest", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Positive", "supply_status": "High",
            "season": "Normal",
        }, headers=headers)
...
class TestMetering:
    ...
    def test_metering_records_simulation(self, auth_client):
        ...
        client, headers, _ = auth_client
        client.post("/api/v1/simulate", json={
            "product": "MeterTest", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Positive", "supply_status": "High",
            "season": "Normal",
        }, headers=headers)
    ...
    def test_metering_breakdown(self, auth_client):
        ...
        client, headers, _ = auth_client
        client.post("/api/v1/simulate", json={
            "product": "BreakdownTest", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Neutral", "supply_status": "Medium",
            "season": "Normal",
        }, headers=headers)
...
class TestStructuredLogging:
    ...
    def test_context_vars_default(self):
        ...
        from logging_config import request_id_var, user_id_var, org_id_var
