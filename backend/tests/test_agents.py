...
class TestDemandAgent:
    ...
    def test_negative_market_offseason(self):
        ...
        result = self.agent.run(demand=5000, market_trend="Negative", season="Off-season")
...
class TestInventoryAgent:
    ...
    def test_medium_supply(self):
        ...
        result = self.agent.run(predicted_demand=1000, stock=500, supply_status="Medium")
    ...
    def test_confidence_small_gap(self):
        ...
        result = self.agent.run(predicted_demand=1000, stock=950, supply_status="Medium")
...
class TestRiskAgent:
    ...
    def test_high_risk(self):
        ...
        result = self.agent.run(supplier_delay=10, supply_status="Low", market_trend="Negative")
        assert result.output_data["risk_level"] == "High"

    def test_low_risk(self):
        """No delay + High supply + Positive market → Low risk."""
        result = self.agent.run(supplier_delay=0, supply_status="High", market_trend="Positive")
        assert result.output_data["risk_level"] == "Low"

    def test_medium_risk(self):
        """Moderate delay + Medium supply + Neutral market → Medium risk."""
        result = self.agent.run(supplier_delay=4, supply_status="Medium", market_trend="Neutral")
...
class TestLogisticsAgent:
    ...
    def test_home_bonus_applies(self):
        ...
        scores = result.output_data["warehouse_scores"]
