...
class TestDataIsolation:
    ...
    def test_simulation_list_isolation(self, client):
        ...
        for _ in range(3):
            resp = client.post("/api/v1/simulate", json={
                "product": "W", "stock": 100, "warehouse": "W1",
        ...
        resp = client.post("/api/v1/simulate", json={
            "product": "X", "stock": 50, "warehouse": "W2",
            "demand": 25, "supplier_delay": 1,
            "market_trend": "Negative", "supply_status": "Low",
            "season": "Festival",
        }, headers=headers_b)
    ...
    def test_cross_org_twin_delete_blocked(self, client):
        ...
        resp = client.post("/api/v1/twins", json={"name": "Protected"}, headers=headers_a)
        twin_id = resp.json()["id"]
    ...
    def test_cross_org_scenario_blocked(self, client):
        ...
        sim_resp = client.post("/api/v1/simulate", json={
            "product": "Q", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Positive", "supply_status": "High",
            "season": "Normal",
        }, headers=headers_a)
...
class TestUnauthenticatedAccess:
    ...
    def test_simulate_requires_auth(self, client, monkeypatch):
        ...
        resp = client.post("/api/v1/simulate", json={
            "product": "X", "stock": 100, "warehouse": "W1",
            "demand": 50, "supplier_delay": 2,
            "market_trend": "Positive", "supply_status": "High",
            "season": "Normal",
        })
