...
class TestTokenRefresh:
    ...
    def test_refresh_with_org_switch(self, client):
        ...
        org_resp = client.post("/api/v1/orgs/", json={"name": "Second Org"}, headers=headers)
...
class TestAPIKeys:
    ...
    def test_revoke_api_key(self, client):
        ...
        headers = _auth_headers(reg["access_token"])
        create_resp = client.post("/api/v1/auth/api-keys", json={"name": "Temp"}, headers=headers)
    ...
    def test_auth_with_api_key(self, client):
        ...
        headers = _auth_headers(reg["access_token"])
        create_resp = client.post("/api/v1/auth/api-keys", json={"name": "AuthTest"}, headers=headers)
