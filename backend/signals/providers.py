...
_NEWS_HEADLINES = [
    {"headline": "Port congestion delays shipments across major trade routes", "category": "logistics", "base_score": 65},
    {"headline": "Factory fire disrupts component supply in manufacturing hub", "category": "supply", "base_score": 80},
    {"headline": "Trade tariffs announced affecting raw material imports", "category": "trade", "base_score": 55},
    {"headline": "Labor strikes halt operations at key distribution centers", "category": "logistics", "base_score": 70},
    {"headline": "New trade agreement opens alternative supply routes", "category": "trade", "base_score": 20},
    {"headline": "Semiconductor shortage eases as new facilities come online", "category": "supply", "base_score": 15},
    {"headline": "Cyber attack disrupts logistics network operations", "category": "security", "base_score": 85},
    {"headline": "Regulatory changes require supply chain restructuring", "category": "regulatory", "base_score": 45},
]
...
_WEATHER_CONDITIONS = [
    ...
    {"condition": "Hurricane/Typhoon", "severity_level": "extreme", "base_severity": 1.0},
