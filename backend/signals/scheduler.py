...
from signals.providers import get_provider, DEFAULT_PROVIDERS
    ...
    for category in DEFAULT_PROVIDERS:
        try:
            ...
            logger.info(
                ...
                category, provider.source_name, provider.SCHEMA_VERSION,
            )
        except Exception:
            results[category] = False
