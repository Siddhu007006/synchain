...
class SimulationInput(BaseModel):
    ...
    warehouse: Literal["W1", "W2", "W3"] = Field(..., description="Current warehouse identifier")
...
class AgentBreakdownItem(BaseModel):
    ...
    input_summary: dict = Field(..., description="Concise dict of fields consumed by this agent")
...
class ScenarioImpact(BaseModel):
    ...
    recommendation_changed: bool = Field(..., description="Whether the recommendation changed")
    warehouse_changed: bool = Field(default=False, description="Whether warehouse selection changed")
...
class ScenarioComparison(BaseModel):
    ...
    scenario_description: str = Field(..., description="What was changed in the scenario")
