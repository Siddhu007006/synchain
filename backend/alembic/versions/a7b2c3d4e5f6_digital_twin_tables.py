...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(), nullable=False, server_default='Default Supply Chain'),
    ...
    op.create_table(
        'product_states',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('twin_id', sa.Integer(), sa.ForeignKey('digital_twins.id'), nullable=False),
    ...
    op.create_index('ix_product_states_product_name', 'product_states', ['product_name'])
    ...
    op.create_table(
        'supplier_states',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('twin_id', sa.Integer(), sa.ForeignKey('digital_twins.id'), nullable=False, unique=True),
    ...
    op.create_index('ix_twin_state_history_changed_at', 'twin_state_history', ['changed_at'])
