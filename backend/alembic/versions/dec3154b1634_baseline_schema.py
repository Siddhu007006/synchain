...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('market_trend', sa.String(), server_default='Neutral', nullable=False),
        sa.Column('supply_status', sa.String(), server_default='Medium', nullable=False),
    ...
    op.create_table(
        'results',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('simulation_id', sa.Integer(), sa.ForeignKey('simulations.id'), unique=True, nullable=False),
