...
const codeExamples = [
  {
    label: "Install",
    code: `pip install fastapi uvicorn sqlalchemy
...
uvicorn main:app --reload --port 8000`,
  ...
  {
    label: "Simulate",
    code: `const res = await fetch('/simulate', {
  method: 'POST',
...
const { input, result: decision } = await result.json()

console.log('Forecast:', decision.demand_forecast)
